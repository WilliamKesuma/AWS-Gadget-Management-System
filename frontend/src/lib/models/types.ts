...
export type FinanceNotificationStatus = z.infer<
  typeof FinanceNotificationStatusSchema
>
...
export const ReturnFileManifestItemTypeSchema = z.enum([
  'photo',
  'admin-signature',
])
export type ReturnFileManifestItemType = z.infer<
  typeof ReturnFileManifestItemTypeSchema
>
...
export type ListPendingSignaturesResponse =
  PaginatedAPIResponse<PendingSignatureItem>
...
export type ListPendingReplacementsResponse =
  PaginatedAPIResponse<PendingReplacementListItem>

// ---------------------------------------------------------------------------
// Pending Returns (assets with approved replacement issues)
// ---------------------------------------------------------------------------

export type ListPendingReturnsFilter = PaginatedAPIFilter
...
export type ListPendingReturnsResponse = PaginatedAPIResponse<PendingReturnItem>
...
export type ListSoftwareRequestsResponse =
  PaginatedAPIResponse<SoftwareRequestListItem>
...
export type ListAllSoftwareRequestsResponse =
  PaginatedAPIResponse<AllSoftwareRequestListItem>
...
export type ListPendingDisposalsResponse =
  PaginatedAPIResponse<PendingDisposalItem>
...
export type ListNotificationsResponse =
  PaginatedAPIResponse<NotificationItem> & {
    unread_count: number
  }
...
export type ListAuditLogsResponse = PaginatedAPIResponse<AuditLogItem>
...
export type ITAdminStatsResponse = {
  total_assets: number
  pending_issues: number
  in_maintenance: number
}

export type ManagementStatsResponse = {
  total_assets: number
  pending_approvals: number
  scheduled_disposals: number
}
...
export type AssetDistributionResponse = {
...
export type ApprovalHubResponse = {
...
export type AssetsPageStatsResponse = {
  total_assets: number
  in_stock: number
  assigned: number
  in_maintenance: number
...
export type RequestsITAdminStatsResponse = {
  completed_today: number
  total_active_requests: number
  pending_returns: number
}

export type RequestsEmployeeStatsResponse = {
  active_requests: number
  pending_approval: number
  resolved_monthly: number
}
